...
public class ${CLASSNAME}  extends ${CLASS:emxDomainObject} {
    ...
    public Vector getChineseScore(Context context, String args[])
         ...
         for (int i=0;i<objectList.size();i++) {
         	...
         	resultsVector.add(jedis.hmget(studentID, "ChineseScore").iterator().next());
         }
         System.out.println("resultsVector====="+resultsVector.toString());
...
/*        HashMap programMap  = (HashMap)JPO.unpackArgs(args);
    ...
    public String getChinese(Context context, String args[])
         ...
         MapList mapList            = new MapList();
        	...
        	System.err.println("****************attributeString********************"+attributeString);
