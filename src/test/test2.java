...
import com.matrixone.apps.domain.DomainRelationship;s
...
//till here
        ...
        try {
            ...
            */
            if (sCompNewName != null && !"".equals(sCompNewName) && !"null".equals(sCompNewName))
            {
                ...
                {
                    String strCmd = "list user \"" + sCompNewName + "\" ";
                    String strResult = MqlUtil.mqlCommand(context, strCmd, true);
                    if (!"".equals(strResult)) {
                        bufMessage
                                .append(i18nNow
                                        .getI18nString(
    ...
    */
    ...
    private boolean hasAdminUserRole(Context context, String compNewName) throws Exception {
        ...
        String strResult = MqlUtil.mqlCommand(context, "list role '" + compNewName + "' where 'isanorg'", true);
