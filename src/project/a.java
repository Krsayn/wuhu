...
//added for the bug 341480 End
     ...
     */
       ...
       public void revokeAccessGrantedByRouteAccessGrantorOnRouteContent(Context context, String[] args) throws Exception {
           ...
           DomainObject.MULTI_VALUE_LIST.add("from["+RELATIONSHIP_ROUTE_NODE+"].to.id");
           DomainObject.MULTI_VALUE_LIST.add("from["+RELATIONSHIP_ROUTE_NODE+"].to.name");
           DomainObject.MULTI_VALUE_LIST.add("from["+RELATIONSHIP_ROUTE_NODE+"].to.type");
           DomainObject.MULTI_VALUE_LIST.add("from["+RELATIONSHIP_ROUTE_NODE+"].to.physicalid");	
       ...
       public HashMap createRouteProcess(Context context, String[] args) throws Exception
       {
           ...
           if((objectId != null && !"".equals(objectId) && !"null".equals(objectId)) )
           {
             ...
             try
             {
                 ...
                 System.out.println("routeDetails=======>"+routeDetails);
           ...
           if(rtSelected) {
            ...
            // System.out.println("personSelect========>"+personSelect);
                   ...
                   if((DomainObject.TYPE_ROUTE_TASK_USER).equals(personObj.getTypeName()) || ((DomainObject.TYPE_PERSON).equals(personObj.getTypeName()))  ) {
                    ...
                    if(((DomainObject.TYPE_ROUTE_TASK_USER).equals(personObj.getTypeName())))
                    {
                        ...
                        try{
                            ...
                            System.out.println("**** Access  Coming *****");
                        }
                        }
             ...
             if(accessUtil.getAccessList().size() > 0){
                 ...
                 System.out.println(" it is point two");         
             }
...
/**
		...
		public int checkAssigneeForTask(Context context,String[] args)throws Exception
		{
			if(args!=null && args.length>1){
			  ...
			  selectStmts.addElement(boRoute.SELECT_TYPE);
			
			  StringList relStmts= new StringList();
			  relStmts.addElement("attribute["+DomainObject.ATTRIBUTE_ROUTE_TASK_USER+"]");
		...
		public int RouteTest(Context context, String[] args) throws Exception{
			Route route = (Route) DomainObject.newInstance(context, DomainConstants.TYPE_ROUTE);
		    String version = "";
		    ...
		    routeId = FrameworkUtil.autoName(context, typeAlias, AutoNameSeries, policyAlias);
		    System.out.println("routeId=======>" + routeId);
		    System.out.println(" *** success create route *** ");
		    ...
		    String objectId = "58813.57799.11603.43424";
		    String strTypeName = "";
		    if (objectId != null && !"".equals(objectId) && !"null".equals(objectId)) {
		        DomainObject boProject = new DomainObject(objectId);
		        strTypeName = boProject.getInfo(context, "type");
		    ...
		    String routeDescription = "批准一个任务";
		    ...
		    String sTemplateId = "58813.57799.36701.50798";
		    ...
		    if (WSNotSelected) {
		        if ((objectId != null && !"".equals(objectId) && !"null".equals(objectId))) {
		            ...
		            routeDetails.put(objectId, objState);
		            System.out.println(" **** test coming **** 111 ");
		            boolean isProjId = false;
