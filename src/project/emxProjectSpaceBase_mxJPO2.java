  	...
  	public Map createNewProject(Context context,String[]args)throws Exception
  	{
  		...
  		try{
			...
			String sKeepSourceConstraints = (String)programMap.get("keepSourceConstraints");
  			...
  			String GWProduct 			= (String)programMap.get("GWProduct");
  			String productId 			= (String)programMap.get("GWProductOID");
  			System.out.println("GWProduct============================"+GWProduct);
			...
			if(ProgramCentralUtil.isNullString(sKeepSourceConstraints) || "false".equalsIgnoreCase(sKeepSourceConstraints)){
  			...
  			if("Blank".equalsIgnoreCase(createProject) || 
  			 ...
  			 //2018-03-19  Project connect Part
  			//System.out.println("newProject---type====================="+newProject.getTypeName());		
  			DomainObject gwProduct = new DomainObject(productId);
  			//System.out.println("productId---type====================="+gwProduct.getTypeName());
  			DomainRelationship.connect(context, gwProduct, "GWProductRelProject",newProject);
  			//Get new project ID
...
//        	 mlMasterPlanGates = deliverablePlanGate.getMasterPlanGates(context, deliverableId, null);
   ...
   public boolean isAddingShadowGateEnabled(Context context,String args[]) throws Exception
   {
	  ...
	  /**
	    ...
	    public MapList getProjectTemplatesAndProjects(Context context, String args[]) throws Exception {
			...
			while(objectlistIterator.hasNext()){
				...
				if("True".equalsIgnoreCase(isKindOfExperiment) || "True".equalsIgnoreCase(isKindOfProjectBaseline)){
    ...
    public void updateGWProduct(Context context, String args[])
            throws Exception {
    	 System.out.println("************** i am coming Project Space ye ye ye *********************");
    	    Map programMap 					= (HashMap) JPO.unpackArgs(args);
    	    HashMap requestMap = (HashMap) programMap.get("requestMap");
			String objectId 				= (String)requestMap.get("objectId");
			String gwProduct 			= (String)requestMap.get("GWProduct");
			String productId 			= (String)requestMap.get("GWProductOID");
